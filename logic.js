...
// This function showWinner is primarily generated by ChatGPT
...
// This function drawWinningLine is primarily generated by ChatGPT
function drawWinningLine(size, ...winningCombination) {
  ...
  if (size === 3) {
    startX = positions[0].left + positions[0].width / 2;
    startY = positions[0].top + positions[0].height / 2;
    endX = positions[2].left + positions[2].width / 2;
    endY = positions[2].top + positions[2].height / 2;
  } else if (size === 4) {
