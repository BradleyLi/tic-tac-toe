...
button0.addEventListener("click", () => checkWinLarge());
button1.addEventListener("click", () => checkWinLarge());
button2.addEventListener("click", () => checkWinLarge());
button3.addEventListener("click", () => checkWinLarge());
button4.addEventListener("click", () => checkWinLarge());
button5.addEventListener("click", () => checkWinLarge());
button6.addEventListener("click", () => checkWinLarge());
button7.addEventListener("click", () => checkWinLarge());
button8.addEventListener("click", () => checkWinLarge());
button9.addEventListener("click", () => checkWinLarge());
button10.addEventListener("click", () => checkWinLarge());
button11.addEventListener("click", () => checkWinLarge());
button12.addEventListener("click", () => checkWinLarge());
button13.addEventListener("click", () => checkWinLarge());
button14.addEventListener("click", () => checkWinLarge());
button15.addEventListener("click", () => checkWinLarge());
